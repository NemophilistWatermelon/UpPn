const n={},e=`<h2>mapbox课程3 创建一个点</h2>
<blockquote>
<p>准备点位数据，准备撒点图标，将数据源和图层添加到地图上</p>
</blockquote>
<br/>
<ul>
<li>课程地址</li>
...
<pre><code class="language-javascript">map.loadImage(
...
<pre><code class="language-javascript">var pointDataGeojson2 = {
...
<pre><code class="language-javascript">var pointSource = {
 type: 'geojson',
 data: {
   type: &quot;FeatureCollection&quot;,
   features: []
...
<pre><code class="language-javascript">var pointLayer1 = {
 id: 'pointLayer2',
 type: 'symbol',
 source: 'pointSource',
 layout: {
